var config_data = `
{
  ...
  "teleop": [
    ...
    { "name": "Stratégie de passes",
      "code": "pas",
      "type": "radio",
      "choices": {
        "n": "Aucune passe<br>",
        "o": "Quelques passes<br>",
        "f": "Machine à passes (Feeder)"
      },
      "defaultValue": "n"
    },
    { "name": "Ramassage au Dépôt",
  ...
  "postmatch": [
    ...
    { "name": "Instable (a failli basculer)",
      "code": "tip",
      "type": "bool"
    },
